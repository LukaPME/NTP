#line 1 "D:/Luka-Probe/MicroC/NTP/httpUtils.c"
...
#line 34 "D:/Luka-Probe/MicroC/NTP/httpUtils.c"
...
#line 80 "D:/Luka-Probe/MicroC/NTP/httpUtils.c"
const char HTTP_b64_reverse[] = "|$$$}rstuvwxyz{$$$$$$$>?@ABCDEFGHIJKLMNOPQRSTUVW$$$$$$XYZ[\\]^_`abcdefghijklmnopq" ;
#line 89 "D:/Luka-Probe/MicroC/NTP/httpUtils.c"
...
#line 99 "D:/Luka-Probe/MicroC/NTP/httpUtils.c"
...
#line 159 "D:/Luka-Probe/MicroC/NTP/httpUtils.c"
unsigned char HTTP_basicRealm(unsigned int l, unsigned char *passwd)
 {
 unsigned int len = 0 ;
 unsigned int i ;
...
#line 202 "D:/Luka-Probe/MicroC/NTP/httpUtils.c"
unsigned char HTTP_getRequest(unsigned char *buf, unsigned int *len, unsigned int max)
 {
 unsigned int i ;
#line 209 "D:/Luka-Probe/MicroC/NTP/httpUtils.c"
...
#line 221 "D:/Luka-Probe/MicroC/NTP/httpUtils.c"
...
#line 244 "D:/Luka-Probe/MicroC/NTP/httpUtils.c"
unsigned int HTTP_accessDenied(const unsigned char *zn, const unsigned char *m)
 {
 unsigned int len ;
...
#line 260 "D:/Luka-Probe/MicroC/NTP/httpUtils.c"
unsigned int HTTP_redirect(unsigned char *url)
 {
 unsigned int len ;
...
#line 275 "D:/Luka-Probe/MicroC/NTP/httpUtils.c"
unsigned int HTTP_html(const unsigned char *html)
 {
 unsigned int len ;
...
#line 289 "D:/Luka-Probe/MicroC/NTP/httpUtils.c"
unsigned int HTTP_imageGIF(const unsigned char *img, unsigned int l)
 {
 unsigned int len ;
...
#line 304 "D:/Luka-Probe/MicroC/NTP/httpUtils.c"
unsigned int HTTP_error()
 {
 int len;
